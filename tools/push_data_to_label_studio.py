...
def push_voc_to_label_studio(proj_id, img_dir, anno_dir, server_img_dir, cls_file=None):
    '''
...
if __name__ =='__main__':
    ...
    anno_dir='/home/misa/PycharmProjects/MISA.eKYC2/data/idcard_segment/trainval/anno_yolo'
    server_img_dir ='/data/local-files/?d=label-studio/data/external/idcard_segment'
    push_voc_to_label_studio(proj_id,
                             img_dir,
                             anno_dir,
                             server_img_dir,
                             cls_file=None)